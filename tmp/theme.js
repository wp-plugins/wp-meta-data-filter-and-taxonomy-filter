...
//pagination fix
    var pag_links = jQuery('ul.page-numbers').find('li a.page-numbers');

    $.each(pag_links, function (index, a) {

        jQuery(a).attr('href', jQuery(a).attr('href').replace('product#038;', 'product&'));
