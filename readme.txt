...
FREE FEATURES:
    * WooCommerce (2.1.x and 2.2.x and higher) products searching by price and product categories
    * Search by post title
    * Create new meta fields with built-in constructor (checkbox, drop-down, range-slider, calendar, textinput)
    * The 'Reflection' functionality for metafields for working with already existed metafields of your site. Reflections – is functionality for synchronizing new meta fields with already existing meta fields and makes them searchable!
    * Reset button
