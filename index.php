...
require plugin_dir_path(__FILE__) . 'classes/woosort.php';
//ext
require plugin_dir_path(__FILE__) . 'ext/helper.php';
//require plugin_dir_path(__FILE__) . 'ext/marketing.php';
require plugin_dir_path(__FILE__) . 'ext/simple-taxonomy-chain-menu.php';
...
//set settings
                    $data = array(
                        ...
                        'ajax_searching' => 0,
                        'show_panel_orderby_date' => 1,
                        'show_panel_orderby_title' => 1,
...
//***
    ...
    public static function data_meta_box_style() {
        ...
        <br />
        <h5 style="margin:0;"><?php _e("On front (widget) (in premium)", 'meta-data-filter') ?>:</h5>
        <input type="text" readonly="" name="widget_section_max_height" placeholder="px" value="<?php echo (int) get_post_meta($post->ID, 'widget_section_max_height', true) ?>" /><br />
        <br />
        ...
        <br />
        <h4><?php _e("The section toggle (in premium)", 'meta-data-filter') ?>:</h4>
        <?php
        $toggles = array(
        ...
        ?>
        <select disabled="" name="widget_section_toggle" class="postform">
...
//***
    ...
    public function woo_main_before() {
        //echo do_shortcode('[mdf_draw_sort_by_filter]');
    }
...
//update old keys in posts which are using it
    ...
    public static function add_additional_taxonomies($additional_taxonomies, $register_request = TRUE) {
        ...
        return $_REQUEST['MDF_ADDITIONAL_TAXONOMIES'];
    }
...
//Update widget
    function update($new_instance, $old_instance) {
        ...
        $instance['ajax_items_recount'] = 'false';
