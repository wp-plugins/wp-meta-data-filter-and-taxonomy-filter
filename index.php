<?php
/*
  Plugin Name: WordPress Meta Data & Taxonomies Filter (MDFT)
...
//Basic settings
        $settings = array('classname'=>__CLASS__, 'description'=>__('Meta Data Filter main widet', 'meta-data-filter'));

//Creation
        $this->WP_Widget(__CLASS__, __('MDFT', 'meta-data-filter'), $settings);
    }
...
//Widget Setup
    function __construct() {
//Basic settings
        $settings = array('classname'=>__CLASS__, 'description'=>__('Meta Data Filter single post data', 'meta-data-filter'));

//Creation
        $this->WP_Widget(__CLASS__, __('MDFT single page', 'meta-data-filter'), $settings);
    }
