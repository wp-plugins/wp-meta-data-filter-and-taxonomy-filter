...
//require plugin_dir_path(__FILE__) . 'ext/completeyourcar.php';
//
//
//20-04-2015
...
//Widget Setup
    ...
    {
//Basic settings
        $settings = array('classname' => __CLASS__, 'description' => __('MDTF single post data', 'meta-data-filter'));

//Creation
        $this->WP_Widget(__CLASS__, __('MDTF single page', 'meta-data-filter'), $settings);
    }
