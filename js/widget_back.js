                ...
                buttons: {
                    0: {
                        ...
                        action: function(__self) {
                            ...
                            jQuery('#' + id_select_size).val('');
                            jQuery('input[name="'+name_show_child_terms+'"]').val('');
                            jQuery('input[name="'+name_section_toggle+'"]').val('');
                            jQuery('#' + id_tax_title).val('');
                            jQuery('#' + id_checkbox_max_height).val('');
