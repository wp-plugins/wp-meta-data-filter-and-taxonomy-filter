...
if(!isset($_REQUEST['meta_data_filter_works']) AND $wp_query->is_main_query()) {//anti endless loop
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    if(isset($_REQUEST['mdf_cat']) AND $_REQUEST['mdf_cat'] != -1) {
        $tmp_add = true;
    ...
    //print_r($args);
//***
    $order_by_array = array('date', 'title');
...
//***
    ...
    if(!isset($_REQUEST['mdf_get_query_args_only'])) {
        ...
        //***
        //FOR CUSTOMS WHEN A LOT OF RAX ONLY WIDGETS
        /*
          $tmp = $args['tax_query'];
          unset($tmp['relation']);
          if(!empty($tmp)) {
