...
<a class="button button-primary button-medium add_item_to_data_group" data-add-to='top' href="#"><?php _e("Prepend Item", 'meta-data-filter') ?></a><br />
<br />
<?php global $post; ?>
...
<br />
<a class="button button-primary button-medium add_item_to_data_group" data-add-to='bottom' href="#"><?php _e("Append Item", 'meta-data-filter') ?></a><br />
