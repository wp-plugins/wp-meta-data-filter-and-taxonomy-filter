...
<ul>
    ...
    <li>
        <input class="mdf_popup_terms_tax_title" readonly="" style="width: 50%;" type="text" name="" value="<?php echo $tax_title; ?>" /><b>&nbsp;<?php echo _e('Custom name/title for taxonomies', 'meta-data-filter'); ?></b><br />
    ...
    <li class="mdf_selects_item" <?php if($show_how != 'select'): ?>style="display: none;"<?php endif; ?>>
        <input class="mdf_popup_terms_select_size" readonly="" style="width: 50%;" type="text" name="" value="<?php echo $select_size; ?>" />&nbsp;<b><?php echo _e('Drop-down size', 'meta-data-filter'); ?></b><br />
    </li>
    <li class="mdf_checkboxes_item" <?php if($show_how != 'checkbox'): ?>style="display: none;"<?php endif; ?>>
        <input class="mdf_popup_terms_checkbox_max_height" readonly="" style="width: 50%;" placeholder="px" type="text" name="" value="<?php echo $checkbox_max_height; ?>" />&nbsp;<b><?php echo _e('Block max height', 'meta-data-filter'); ?></b><br />
    ...
    ?>
    <li class="mdf_selects_item" <?php if($show_how != 'select'): ?>style="display: none;"<?php endif; ?>>
        <select disabled="" style="width: 50%;" class="mdf_popup_terms_show_child_terms">
    ...
    <li>
        ...
        ?>
        <select disabled="" name="mdf_popup_terms_section_toggles" class="mdf_popup_terms_section_toggles">
