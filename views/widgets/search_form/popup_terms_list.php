...
<ul>
    ...
    <li>
        <input class="mdf_popup_terms_tax_title" style="width: 50%;" type="text" disabled="" name="" value="" placeholder="In the premium version only" /><b>&nbsp;<?php echo _e('Custom name/title for taxonomies', 'meta-data-filter'); ?></b><br />
    ...
    ?>
    <li class="mdf_selects_item" <?php if($show_how != 'select'): ?>style="display: none;"<?php endif; ?>>
        <select style="width: 50%;" class="mdf_popup_terms_show_child_terms" disabled="">
            <option <?php selected($show_child_terms, 0) ?> value="0"><?php echo _e('In the premium version only!', 'meta-data-filter'); ?></option>
