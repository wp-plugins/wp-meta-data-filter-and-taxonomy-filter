...
//+++
    ...
    <div class="widget widget-meta-data-filter">
        ...
        <?php if(isset($_REQUEST['meta_data_filter_count'])): ?>
            <i class="mdf_widget_found_count"><?php echo sprintf(__('Found totally %s items', 'meta-data-filter'), $_REQUEST['meta_data_filter_count']) ?></i><br />
        <?php endif; ?>
        ...
        <script type="text/javascript">
            jQuery(function() {
                mdf_init_search_form("<?php echo $uniqid ?>", "<?php echo $instance['meta_data_filter_slug'] ?>", "<?php echo $search_url ?>", 0, 0);
            });
        </script>
