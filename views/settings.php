    ...
    <form action="<?php echo admin_url('edit.php?post_type=' . MetaDataFilterCore::$slug . '&page=mdf_settings') ?>" method="post">
        ...
        <div id="tabs">
            ...
            <div id="tabs-2">
                ...
                <table class="form-table">
                    <tbody>
                        ...
                        <tr valign="top">
                            <th scope="row"><label><?php _e("Use sort-by buttons", 'meta-data-filter') ?></label></th>
                            <td>

                                <fieldset>
                                    <label>
                                        <input type="checkbox" <?php if (isset($data['show_panel_orderby_date'])) echo 'checked'; ?> value="1" name="meta_data_filter_settings[show_panel_orderby_date]" />
                                        <?php _e("by Date", 'meta-data-filter') ?>
                                    </label>
                                </fieldset>
                                ...
                                <fieldset>
                                    <label>
                                        <input type="checkbox" <?php if (isset($data['show_panel_orderby_title'])) echo 'checked'; ?> value="1" name="meta_data_filter_settings[show_panel_orderby_title]" />
                                        <?php _e("by Title", 'meta-data-filter') ?>
                                    </label>
                                </fieldset>

                                <p class="description">
                                    <img src="<?php echo MetaDataFilter::get_application_uri() ?>images/default_sort_by.png" alt="" /><br />
                                </p>
                            </td>
                        </tr>
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" readonly="" class="regular-text" value="<?php echo(isset($data['toggle_open_sign']) ? $data['toggle_open_sign'] : '+') ?>" name="meta_data_filter_settings[toggle_open_sign]">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" readonly="" class="regular-text" value="<?php echo(isset($data['toggle_close_sign']) ? $data['toggle_close_sign'] : '-') ?>" name="meta_data_filter_settings[toggle_close_sign]">
                    ...
                    <tbody>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <fieldset>
                                    <label>
                                        <input type="checkbox" disabled="" value="0" name="meta_data_filter_settings[use_chosen_js_s]" />
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <fieldset>
                                    <label>
                                        <input id="use_custom_scroll_bar" disabled="" type="checkbox" value="0" name="meta_data_filter_settings[use_custom_scroll_bar]" />
                                    </label>
                                </fieldset>
                        ...
                        <tbody>
                            <tr valign="top">
                                ...
                                <td>
                                    <fieldset>
                                        <label>
                                            <input id="mdtf_label_41" type="checkbox" disabled="" value="0" name="meta_data_filter_settings[exclude_out_stock_products]" />
                                        </label>
                                    </fieldset>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <fieldset>
                                        <label>
                                            <input id="mdtf_label_42" disabled="" type="checkbox" <?php if (isset($data['try_make_shop_page_ajaxed'])) echo 'checked'; ?> value="1" name="meta_data_filter_settings[try_make_shop_page_ajaxed]" />
                                        </label>
                                    </fieldset>
                                    <p class="description"><?php _e("In premium only. Check it if you want to make ajax searching directly on woocommerce shop page. BUT! It is not possible for 100% because a lot of wordpress themes developers not use in the right way woocommerce hooks woocommerce_before_shop_loop AND woocommerce_after_shop_loop. Works well with native woocommerce themes as Canvas and Primashop for example!", 'meta-data-filter') ?></p>
                                </td>
                            </tr>
            ...
            <div id="tabs-5">
                <p>
                <p>
                    Uses for [<a target="_blank" href="http://wordpress-filter.com/features/shortcode-mdf_results_by_ajax/">mdf_results_by_ajax</a>] shortcode in the premium version of the plugin.<br /> 
                </p>
                </p>
            </div>
            ...
            <div id="tabs-6" style="display: none;">
                ...
                <table class="form-table">
                    <tbody>
                        <tr valign="top" style="display: none;">
                            <th scope="row"><label for="marketing_short_links"><?php _e("Use marketing short links", 'meta-data-filter') ?></label></th>
                            <td>
                                <fieldset>
                                    <label>
                                        <input id="marketing_short_links" type="checkbox" <?php if (isset($data['marketing_short_links'])) echo 'checked'; ?> value="1" name="meta_data_filter_settings[marketing_short_links]" />
                                    </label>
                                </fieldset>
                                <p class="description"><?php _e("Using this the plugin addon you can create short links for your filtered posts/custom types. Example: http://your_site.com/mdf/192/seo-suffix-words-for-google", 'meta-data-filter') ?></p>
                                <p class="description"><?php _e("This extension maybe will be removed in future versions. Use please this free plugin: https://wordpress.org/plugins/pretty-link/", 'meta-data-filter') ?></p>
                                <br />
                                <hr />
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row"><label for="ext_activate_taxonomy_chain_menu"><?php _e("Activate simple taxonomy chain menu shortcode", 'meta-data-filter') ?></label></th>
                            <td>
                                <fieldset>
                                    <label>
                                        <input id="ext_activate_taxonomy_chain_menu" type="checkbox" <?php if (isset($data['ext_activate_taxonomy_chain_menu'])) echo 'checked'; ?> value="1" name="meta_data_filter_settings[ext_activate_taxonomy_chain_menu]" />
                                    </label>
                                </fieldset>
                                <p class="description"></p>
                            </td>
