...
<div style="display:none;" class="mdf_admin_flter_item_box">
    ...
    <div class="data_group_item_html">
        ...
        <div class="mdf_item_footer" <?php if (isset($itemdata) AND ( $itemdata['type'] == 'taxonomy')): ?>style="display: none;"<?php endif; ?>>
            ...
            <input type="text" disabled="" placeholder="medafi_total_sales" value="<?php echo $uniqid ?>" name="html_item[<?php echo $uniqid ?>][meta_key]" style="width: 45%;" />&nbsp;<a href="#" class="button mdf_change_meta_key_butt" data-old-key="<?php echo $uniqid ?>"><?php _e("change meta key", 'meta-data-filter') ?></a><br />
